package com.hcb.hcbsdk.util.dodo;
...
//	比如：Context.MODE_WORLD_READABLE + Context.MODE_WORLD_WRITEABLE 表示其他应用读写；
	 ...
	 * @return
	 */
	static public String getSDDir(String key_dir) {
	...
	// 读取文件
	public static String read(final String abspath)
	{
...
//			fis.close();
	 ...
	 */
	public static String read(final String abspath, final String code)
	{
		FileInputStream fis = null;
		try
		{
