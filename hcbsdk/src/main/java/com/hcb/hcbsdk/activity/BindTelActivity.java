...
public class BindTelActivity extends JKCBaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        hideSystemUI(this);
        setContentView(R.layout.sdk_pager_tel_login);
...
//                finish();
        ...
        rl_login = findViewById(R.id.activity_wechat_capture);
        ...
        mBtn_login.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (!NetStatus.getNetStatus(BindTelActivity.this)) {
                    Utils.showToastCenter(BindTelActivity.this, "您的网络已断开，请检查网络！");
                    return;
                }
                showProgress("加载中...");
                attemptLogin();
        ...
        link_signup.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                SDKManager.getInstance().startAboutPage(BindTelActivity.this);
            }
        });

        tel_input_layout = (TextInputLayout) findViewById(R.id.tel_input_layout);
        vecode_input_layout = (TextInputLayout) findViewById(R.id.vecode_input_layout);
...
//                    AESUtil.encrypt("AES");
                    ...
                    if (status == 1) {
                        startTimer();
                        Utils.showToastCenter(BindTelActivity.this, "验证码已发送");
                    } else
                        Utils.showToastCenter(BindTelActivity.this, ((JSONObject) responseObj).getString("message"));
            ...
            public void onFailure(Object reasonObj) {
                Utils.showToastCenter(BindTelActivity.this, "验证码发送失败");
            }
        });
    }
    ...
    public class MyRecever extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            if (IConstants.LOGIN.equals(intent.getAction())) {
                Utils.showToastCenter(BindTelActivity.this, "绑定成功");
    ...
    private void attemptLogin() {
        ...
        RequestCenter.bindTel(phone, et_vercode.getText().toString(), token,openId, new DisposeDataListener() {
            @Override
            public void onSuccess(Object responseObj) {
                    ...
                    if (status == 200) {
                        ...
                        if (user != null) {
                                if (StringUtils.isEmpty(user.getMobile())) {
                                    Utils.showToastCenter(BindTelActivity.this, "绑定失败");
                                } else {
                                    FileUtil.writeFile
                                            (FileUtil.getSDDir(KEY_DIR_NAME) + KEY_FILE_NAME, responseObj.toString(), false);
                                    TuitaData.getInstance().setUser(loginReslut.getData());
                                    L.info("huacaisdk", "绑定成功");
                                    BroadcastUtil.sendBroadcastToUI(BindTelActivity.this, IConstants.LOGIN, "");
                                }
                        }
                    }
            ...
            public void onFailure(Object reasonObj) {
                try {
                    ...
                    Utils.showToastCenter(BindTelActivity.this, ((OkHttpException) reasonObj).getMsg().toString());
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
